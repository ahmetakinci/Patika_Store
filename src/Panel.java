...
public class Panel {
    ...
    public void orderMobilePhone() {
        ...
        MobilePhone mpXiaomi = new MobilePhone(3, 4012.0, 20, 22,
                "Redmi Note 10 Pro", "Xiaomi", 6, 6.5, 128, "Mobile Phone",
                4000, "White", 35);
    ...
    public void printMobilePhoneList(ArrayList<MobilePhone> mobilePhoneList) {
        String leftAlignFormat = "| %-2d | %-20s | %-11s | %-9s | %-10d | %-9s | %-9s | %-9s | %-9s | %-9s | %-9s | %-9s |%n";
        String headers = "| %-2s | %-20s | %-11s | %-9s | %-10s | %-9s | %-9s | %-9s | %-9s | %-9s | %-9s | %-9s |%n";
        System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------\n");
        System.out.format(headers, "ID", "Ürün Adı", "Fiyat", "Marka ", "Depolama", "Ekran", "Renk", "Batarya", "Kamera", "RAM", "Discount", "Stock");
        System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------\n");
        ...
        for (MobilePhone product : mobilePhoneList) {
            System.out.format(leftAlignFormat, product.getId(),
                    ...
                    product.getInch(), product.getColour(),
                    product.getBattery(), product.getCamera(),
                    product.getRam(), product.getDiscount(),
                    product.getStock());
    ...
    public void printNotebookList(ArrayList<Notebook> notebookList) {
        String leftAlignFormat = "| %-2d | %-20s | %-11s | %-9s | %-10d | %-9s | %-9s | %-9s | %-9s |%n";
        String headers = "| %-2s | %-20s | %-11s | %-9s | %-10s | %-9s | %-9s |%-9s | %-9s |%n";
        System.out.println("----------------------------------------------------------------------------------------------------------------------\n");
        System.out.format(headers, "ID", "Ürün Adı", "Fiyat", "Marka ", "Depolama", "Ekran", "RAM", "Discount", "Stock");
        System.out.println("----------------------------------------------------------------------------------------------------------------------\n");
        ...
        for (Notebook notebook : notebookList) {
            if (notebook.getId() == id)
                System.out.format(leftAlignFormat, notebook.getId(),
                        ...
                        notebook.getDiscount(), notebook.getStock());
        }
    }
